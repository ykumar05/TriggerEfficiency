...
// Wed Nov 30 09:15:25 2022 by ROOT version 6.26/04
// from TTree Events/Events
// found on file: SingleMuon_2018A_1.root
//////////////////////////////////////////////////////////

#ifndef VLLAna_Trigger_h
#define VLLAna_Trigger_h
...
class VLLAna_Trigger : public TSelector {
public :
 ...
 // Readers to access the data (delete the ones you do not need).
  ...
  VLLAna_Trigger(TTree * /*tree*/ =0) { }
   virtual ~VLLAna_Trigger() { }
...
public:                                                   
  struct Hists {
    ...
    TH1F *goodmuons[50];
    TH1F *dR[50];
    TH1F *tagelectrons[50];
    TH1F *probeelectrons[50];
    TH1F *goodelectrons[50];
    TH1F *test[50];
...
private:
  ...
  vector<Lepton> tagMu, probeMu, goodMu, trigObj, tagEle, probeEle, goodEle;
  
   ClassDef(VLLAna_Trigger,0);

};

#endif

#ifdef VLLAna_Trigger_cxx
void VLLAna_Trigger::Init(TTree *tree)
{
...
#endif // #ifdef VLLAna_Trigger_cxx

...
double f_custom(double *x, double *par);
double f_erf(double *x, double *par);
    
void overlayEle()
{
  TFile *fdy   = new TFile("/home/ykumar/Yash/Work/VLLAnalysis_2022/Trigger_Efficiency/hstfiles/Electrons/VLL2018_1L2JAnalysis_TriggerEfficiency_Dec14_v1_DYJetsToLL_M50_sample.root");
  TFile *fdata = new TFile("/home/ykumar/Yash/Work/VLLAnalysis_2022/Trigger_Efficiency/hstfiles/Electrons//VLL2018_1L2JAnalysis_TriggerEfficiency_Dec15_v1_EGamma_2018C_sample.root");
  //TFile *fdy   = new TFile("/home/ykumar/Yash/Work/VLLAnalysis_2022/Trigger_Efficiency/hstfiles/VLL2018_1L2JAnalysis_TriggerEff_Dec9_v2_DYJetsToLL_M50_sample.root");
  //TFile *fdata = new TFile("/home/ykumar/Yash/Work/VLLAnalysis_2022/Trigger_Efficiency/hstfiles/hst_SingleMuon.root");
  
  // Determine the bin-edges; efficiency will be calculated in these bins
  float lowed[] =  {10,20,24,28,30,32,34,36,38,40,60,100};
  float hied[]  =  {20,24,28,30,32,34,36,38,40,60,100,250};

  int nbin = 12; 
  TString plots_mc[4] = {"AllprobeElectron_barrelpT",
			 "AllprobeElectron_barrelpT_trigObjectMatched",
			 "AllprobeElectron_endcappT",
			 "AllprobeElectron_endcappT_trigObjectMatched",
  };
  TString plots_data[4] = {"AllprobeElectron_barrelpT_data",
			   "AllprobeElectron_barrelpT_trigObjectMatched_data",
			   "AllprobeElectron_endcappT_data",
			   "AllprobeElectron_endcappT_trigObjectMatched_data",
			   };
  ...
  c1->SaveAs("TriggerEfficiency_Barrel_Electron.png");
  ...
  c2->SaveAs("TriggerEfficiency_Endcap_Electron.png");
...
double f_custom(double *x, double *par)
{
  double fitval =(x[0])*(par[0]+par[1]*par[2]*TMath::Power(x[0],par[3])-TMath::Exp(par[4]*(x[0]-par[5])));
  return fitval;
}
